...
1) Standstill operation (0 km/h) with an ambient temperature of 40◦C;
2) Constant-speed operation at 40 km/h with an ambient temperature of 40◦C;
3) Constant-speed operation at 80 km/h with an ambient temperature of 40◦C;
4) CLTC driving cycle with an ambient temperature of 38◦C.
